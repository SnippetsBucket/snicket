...
/***/ function(module, exports, __webpack_require__) {
  ...
  var Markdown = function (_Vue) {
    _inherits(Markdown, _Vue);
    ...
    function Markdown() {
      ...
      var properties = {
        ...
        methods: {
          markdownPreview: function markdownPreview() {
            _this.parseMarkdown();
          },
          dispMarkdownEditor: function dispMarkdownEditor() {
            _this.switchActiveEditor(true);
          },
          vPostSnippet: function vPostSnippet() {
            _this.postSnippet();
          }
        }
      };
      return _this = _possibleConstructorReturn(this, (Markdown.__proto__ || Object.getPrototypeOf(Markdown)).call(this, properties));
    }
    ...
    _createClass(Markdown, [{
      ...
      value: function parseMarkdown() {
        ...
        (0, _axios2.default)({
          ...
          _this2.parsedMarkdown = res.data.parsedStr;
          _this2.switchActiveEditor(false);
        }).catch(function (err) {
          console.log(err);
        });
      }
      ...
      value: function switchActiveEditor(switchFlg) {
        this.isActiveEditor = switchFlg;
        this.isActivePreview = !switchFlg;
      }
    }, {
      key: 'postSnippet',
      value: function postSnippet() {
        (0, _axios2.default)({
          method: 'post',
